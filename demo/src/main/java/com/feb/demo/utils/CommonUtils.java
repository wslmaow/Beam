...
import com.feb.demo.Constants;
import com.feb.demo.dialog.MProgressDialog;
...
public class CommonUtils {
    ...
    public static boolean isLogin(Context context, boolean isShow) {
        ...
        boolean isLogin = !isEmpty(UserUtils.getMyString(context, Constants.BundleKey.USER_ID));
    ...
    public static void openBrowser(Context context, String url) {
        ...
        try {
            ...
            Toast.makeText(context, "需要打开的地址不正确 " + url, Toast.LENGTH_SHORT).show();
